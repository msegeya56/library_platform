...
import (
	...
	http "github.com/msegeya56/library_platform/book/pkg/http"
...
var fs = flag.NewFlagSet("book", flag.ExitOnError)
...
func Run(repo repository.BookRepository) {
	fs.Parse(os.Args[1:])
	...
	if *zipkinURL != "" {
		...
		// recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "book")
